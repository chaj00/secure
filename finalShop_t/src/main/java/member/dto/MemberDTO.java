...
public class MemberDTO{
	...
	public String toString() {
		return "MemberDTO [mem_id=" + mem_id + ", mem_nm=" + mem_nm + ", mem_cd=" + mem_cd + ", pwd=" + pwd
				+ ", pwd_hint=" + pwd_hint + ", pwd_hint_ans=" + pwd_hint_ans + ", ssn=" + ssn + ", birth_dt="
				+ birth_dt + ", male_flg=" + male_flg + ", tel_no=" + tel_no + ", cell_no=" + cell_no + ", addr=" + addr
				+ ", email=" + email + ", email_rcv_flg=" + email_rcv_flg + ", mem_reg_dtm=" + mem_reg_dtm + "]";
	}
